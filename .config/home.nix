...
in
{
  ...
  home.file = {
    ...
    -- }}}
      ...
      local terminal   = "alacritty" -- sets the default terminal
      local browser   = "qutebrowser" -- sets the default browser
      local editor     = os.getenv("EDITOR") or "vim" -- sets the default editor
      ...
      local function set_wallpaper(s)
         ...
         if beautiful.wallpaper then
            local wallpaper = "/home/onyx/.nixos/wallpaper.jpg"
      ...
      awful.screen.connect_for_each_screen(function(s)
            ...
            local names = { "1:main", "2:web", "3", "4", "5", "6", "7", "8", "9" }
		  ...
		  require("battery-widget") {ac_prefix="🔌", battery_prefix="🔋"},
                  mytextclock,
                  s.mylayoutbox,
               },
            }
